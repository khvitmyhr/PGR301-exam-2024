...
- **Oppgave 5**
  - **1**: 
    - CI/CD piplines: 
        ...
        - Dette vil likefullt ha den ulempen at programmereren har noe mindre kontroll (på godt og vondt), som kan være en ulempe hvis et problem oppstår. Det kan være vanskeligere å ha oversikt
  ...
  - **2**:
    ...
    - I CloudWatch kan man også bruke alarm ved spesifikke betingelser og man kan enkelt sette opp hvordan en alarm skal trigges. 
    ...
    - Allikevel kan ulempen være at man mister oversikt over det helhetlige bildet. Man har feks innsikt i loggingen til én og en lambda funksjon, og det kan være utfoprdrende å feilsøke dersom det er flere mindre
